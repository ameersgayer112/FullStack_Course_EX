...
class App extends Component {
  ...
  generateCompanyTags(companies) {
    ...
    for (let company of companies) {
      companyTag.push(<Company name={company.name} revenue={company.revenue} />)
    }
    return companyTag;
      ...
      <div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="spotcheck-3">
            {
              companies.map(company => <Company name={this.upperCase(company.name)} revenue={company.revenue} />)
            }
          </div>
        </div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="ex-3">
            {this.state.currentPage === "Landing" ? <Landing user={this.state.user} item={this.state.store.find(s => s.hottest)}/>
             : <Home store={this.state.store} />  }
          </div>
        </div>
